...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, "The sender does not own a token");
        //2. You don't have to check for the price of the token (star)
        //3. Get the owner of the two tokens (ownerOf(_tokenId1), ownerOf(_tokenId1)
        address owner1Address = ownerOf(_tokenId1);
        address owner1Address = ownerOf(_tokenId2);
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        _transferFrom(msg.sender, _to1, tokenId);
    }
